#Bank ATM
#Account Number : 1,2,3 ------------ Password : nikhil123, rohini123, priya123 respectively
...
class Bank:
    def __init__(self,root):
        ...
        self.login = False
        self.root = root
        self.header = Label(self.root,text="Digi Savings Bank",bg="#50A8B0",fg="white",font=("arial",20,"bold")) #for the heading
        ...
        self.uentry = Entry(self.frame,bg="honeydew",highlightcolor="#50A8B0",
           highlightthickness=2,        #for the thickness of the fields
    ...
    def database_fetch(self):   #Fetching data from database
        self.acc_list = []
    ...
    def MainMenu(self):#Main App Appears after logging in
        self.frame = Frame(self.root,width=800,height=400,bg = "black")    # yahan photo chcaaaaaaaaaaaahiyw

        self.frame.config(bg="black")
        self.background_image = PhotoImage(file="WALL.png")
        self.background_label = Label(self.frame, image=self.background_image, bg = "black")
        ...
        self.withdrawal = Button(self.frame, text="Withdraw Money",bg="#50A8B0",fg="white",font=ARIAL,command=self.withdrawal_money)
        self.q = Button(self.frame, text="Quit", bg="#50A8B0", fg="white", font=ARIAL, command=self.root.destroy)
        ...
        self.withdrawal.place(x=600, y=315, width=200, height=50)
    ...
    def withdrawal_money(self):
        ...
        self.money_box.place(x=200,y=100,width=200,height=20)
        self.submitButton.place(x=445,y=100,width=55,height=20)
        self.submitButton.bind("<Button-1>",self.withdrawal_trans)

    def withdrawal_trans(self,flag):
        self.label = Label(self.frame, text="Money Withdrawed !", font=ARIAL)
        self.label.place(x=200, y=100, width=300, height=100)
        self.conn.execute("update atm set bal = bal - ? where acc_no = ?",(self.money_box.get(),self.ac))
        self.conn.commit()
